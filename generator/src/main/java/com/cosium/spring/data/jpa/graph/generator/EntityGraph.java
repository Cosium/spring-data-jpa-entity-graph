...
public class EntityGraph {
  ...
  public EntityGraph(
    ...
    FieldSpec typeField =
        FieldSpec.builder(EntityGraphType.class, "type")
    ...
    MethodSpec rootStaticMethodWithEntityGraphType =
        MethodSpec.methodBuilder("root")
            .addModifiers(Modifier.PUBLIC, Modifier.STATIC)
            .addParameter(EntityGraphType.class, "entityGraphType")
            .returns(rootComposerClassName)
    ...
    typeSpec =
        TypeSpec.classBuilder(entityGraphClassName)
            .addModifiers(Modifier.PUBLIC)
            .addSuperinterface(com.cosium.spring.data.jpa.entity.graph.domain.EntityGraph.class)
            .addField(typeField)
